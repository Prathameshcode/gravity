...
roof = new Roof(650, 100, 1200 , 30)
bob1 = new Bob(340, 500 , 40)
bob2 = new Bob(420, 500 , 40)
bob3 = new Bob(500, 500 , 40)
bob4 = new Bob(580, 500 , 40)
bob5 = new Bob(660, 500 , 40)
rope1 = new Rope(roof.body, bob1.body, -250, 0)
rope2 = new Rope(roof.body, bob2.body, -130,0)
rope3 = new Rope(roof.body, bob3.body,-10,0)
rope4 = new Rope(roof.body, bob4.body,110,0)
rope5 = new Rope(roof.body, bob5.body,240,0)
	Engine.run(engine);
